...
db['projects'] = ["https://replit.com/@BavlyAwadOfficial/SSSpicy-Snake", "https://replit.com/@BavlyAwadOfficial/Secure-Azure-Login-Design-in-Python", "https://replit.com/@BavlyAwadOfficial/aiwallpapers", "https://replit.com/@BavlyAwadOfficial/P2P-Video-Chat-Application", "https://replit.com/@BavlyAwadOfficial/The-Stock-Market-Game", "https://replit.com/@BavlyAwadOfficial/Fly-an-airplane-fixed"]

username = "BavlyAwadOfficial"
...
def profile():
  ...
  name=get_data(query, {"username":"BavlyAwadOfficial"})['data']['userByUsername']['fullName']
